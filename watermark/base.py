...
class BaseWatermark:
    def __init__(self, algorithm_config: Union[str, BaseConfig], transformers_config: TransformersConfig, *args, **kwargs) -> None:
        pass
    ...
    def generate_unwatermarked_text(self, prompt: str, *args, **kwargs) -> str:
        ...
        generated_tokens_only = encoded_unwatermarked_text[0][-200:] 
        edited_text = self.config.generation_tokenizer.decode(generated_tokens_only, skip_special_tokens=True)


        return unwatermarked_text, None, edited_text, generated_tokens_only
